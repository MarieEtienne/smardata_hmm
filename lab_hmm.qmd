...
- **Step Length/Angle**: Metrics from @morales2004extracting, using gamma distribution for step length and von Mises distribution for angles.
- **Bivariate Velocity**: Metrics from @gurarie2009novel, using two independent normal distributions.
